module github.com/aws/amazon-ecs-init/ecs-init
...
replace (
	...
	golang.org/x/net => golang.org/x/net v0.0.0-20170529214944-3da985ce5951
	golang.org/x/sys => golang.org/x/sys v0.0.0-20170529185110-b90f89a1e7a9
)
